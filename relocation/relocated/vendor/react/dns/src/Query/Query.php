...
final class Query
{
    ...
    {
        $class = $this->class !== \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::CLASS_IN ? 'CLASS' . $this->class . ' ' : '';
        $type = 'TYPE' . $this->type;
        $ref = new \ReflectionClass('TenantCloud\\BetterReflection\\Relocated\\React\\Dns\\Model\\Message');
