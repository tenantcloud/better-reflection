...
use TenantCloud\BetterReflection\Relocated\React\Dns\Protocol\BinaryDumper;
use TenantCloud\BetterReflection\Relocated\React\Dns\Protocol\Parser;
 ...
 */
class TcpTransportExecutor implements \TenantCloud\BetterReflection\Relocated\React\Dns\Query\ExecutorInterface
{
    private $nameserver;
    private $loop;
    private $parser;
     ...
     */
    public function __construct($nameserver, \TenantCloud\BetterReflection\Relocated\React\EventLoop\LoopInterface $loop)
    {
    ...
    public function query(\TenantCloud\BetterReflection\Relocated\React\Dns\Query\Query $query)
    {
        ...
        $names =& $this->names;
        $that = $this;
        $deferred = new \TenantCloud\BetterReflection\Relocated\React\Promise\Deferred(function () use($that, &$names, $request) {
