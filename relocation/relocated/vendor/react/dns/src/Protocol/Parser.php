...
namespace TenantCloud\BetterReflection\Relocated\React\Dns\Protocol;

use TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message;
use TenantCloud\BetterReflection\Relocated\React\Dns\Model\Record;
use TenantCloud\BetterReflection\Relocated\React\Dns\Query\Query;
...
final class Parser
{
    ...
    public function parseMessage($data)
    {
        ...
        $message = new \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message();
        $message->data = $data;
    ...
    private function parse($data, \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message $message)
    {
     ...
     * @return ?Query
     */
    private function parseQuestion(\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message $message)
    {
        ...
        return new \TenantCloud\BetterReflection\Relocated\React\Dns\Query\Query(\implode('.', $labels), $type, $class);
    }
    /**
     * @param Message $message
     * @return ?Record returns parsed Record on success or null if data is invalid/incomplete
     */
    private function parseRecord(\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message $message)
    {
        $consumed = $message->consumed;
        ...
        if (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_A === $type) {
            if ($rdLength === 4) {
                $rdata = \inet_ntop(\substr($message->data, $consumed, $rdLength));
                $consumed += $rdLength;
            }
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_AAAA === $type) {
            if ($rdLength === 16) {
                $rdata = \inet_ntop(\substr($message->data, $consumed, $rdLength));
                $consumed += $rdLength;
            }
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_CNAME === $type || \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_PTR === $type || \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_NS === $type) {
            list($rdata, $consumed) = $this->readDomain($message->data, $consumed);
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_TXT === $type) {
            $rdata = array();
        ...
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_MX === $type) {
            if ($rdLength > 2) {
        ...
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_SRV === $type) {
            if ($rdLength > 6) {
        ...
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_SSHFP === $type) {
            if ($rdLength > 2) {
        ...
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_SOA === $type) {
        ...
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_OPT === $type) {
            $rdata = array();
            while (isset($message->data[$consumed + 4 - 1])) {
                ...
                if ($code === \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::OPT_TCP_KEEPALIVE && $value === '') {
                    $value = null;
                } elseif ($code === \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::OPT_TCP_KEEPALIVE && $length === 2) {
                    list($value) = \array_values(\unpack('n', $value));
                    $value = \round($value * 0.1, 1);
                } elseif ($code === \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::OPT_TCP_KEEPALIVE) {
                    break;
                }
                $rdata[$code] = $value;
                $consumed += 4 + $length;
            }
        } elseif (\TenantCloud\BetterReflection\Relocated\React\Dns\Model\Message::TYPE_CAA === $type) {
            if ($rdLength > 3) {
        ...
        $message->consumed = $consumed;
        return new \TenantCloud\BetterReflection\Relocated\React\Dns\Model\Record($name, $type, $class, $ttl, $rdata);
    }
