...
class JunitErrorFormatterTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\ErrorFormatterTestCase
{
    ...
    {
        parent::setUp();
        $this->formatter = new \TenantCloud\BetterReflection\Relocated\PHPStan\Command\ErrorFormatter\JunitErrorFormatter(new \TenantCloud\BetterReflection\Relocated\PHPStan\File\SimpleRelativePathHelper(self::DIRECTORY_PATH));
    }
    /**
    ...
    {
        (yield 'No errors' => [0, 0, 0, '<?xml version="1.0" encoding="UTF-8"?>
...
']);
        (yield 'One file error' => [1, 1, 0, '<?xml version="1.0" encoding="UTF-8"?>
...
']);
        (yield 'One generic error' => [1, 0, 1, '<?xml version="1.0" encoding="UTF-8"?>
<testsuite failures="1" name="phpstan" tests="1" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:noNamespaceSchemaLocation="https://raw.githubusercontent.com/junit-team/junit5/r5.5.1/platform-tests/src/test/resources/jenkins-junit.xsd">
...
']);
        (yield 'Multiple file errors' => [1, 4, 0, '<?xml version="1.0" encoding="UTF-8"?>
...
']);
        (yield 'Multiple generic errors' => [1, 0, 2, '<?xml version="1.0" encoding="UTF-8"?>
...
']);
        (yield 'Multiple file, multiple generic errors' => [1, 4, 2, '<?xml version="1.0" encoding="UTF-8"?>
...
']);
     ...
     */
    public function testFormatErrors(int $exitCode, int $numFileErrors, int $numGeneralErrors, string $expected) : void
    {
