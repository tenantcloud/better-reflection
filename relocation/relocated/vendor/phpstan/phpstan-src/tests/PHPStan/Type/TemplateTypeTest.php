...
class TemplateTypeTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\TestCase
{
    ...
    public function dataIsSuperTypeOf() : array
    {
        ...
        return [0 => [
            ...
            \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(),
        ], 12 => [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\ObjectWithoutClassType()), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\ObjectWithoutClassType(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createYes()], 13 => [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\ObjectWithoutClassType()), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\ObjectType(\DateTimeInterface::class), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe()], 14 => [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\ObjectType(\Throwable::class)), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\ObjectType(\Exception::class), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\MixedType(\true)), $templateType('U', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\UnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\MixedType(\true)), $templateType('U', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BenevolentUnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\ObjectType(\stdClass::class)), $templateType('U', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BenevolentUnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createNo(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createNo()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BenevolentUnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), $templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BenevolentUnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createYes(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createYes()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\UnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), $templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\UnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createYes(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createYes()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\UnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), $templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BenevolentUnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\UnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), $templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType()), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe()], [$templateType('T', new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BenevolentUnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType()])), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\UnionType([new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\BooleanType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\FloatType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\IntegerType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\StringType(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Type\NullType()]), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createMaybe(), \TenantCloud\BetterReflection\Relocated\PHPStan\TrinaryLogic::createYes()]];
    }
    /**
