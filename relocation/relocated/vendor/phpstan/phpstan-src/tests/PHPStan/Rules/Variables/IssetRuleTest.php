...
class IssetRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    ...
    public function testNativePropertyTypes() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/isset-native-property-types.php'], [
            ...
            ['Property IssetNativePropertyTypes\\Foo::$isAssignedBefore (int) in isset() is not nullable.', 20],
        ]);
    }
    ...
    {
        $this->analyse([__DIR__ . '/data/bug-4671.php'], [['Offset string&numeric on array<string, string> in isset() does not exist.', 13]]);
    }
}
