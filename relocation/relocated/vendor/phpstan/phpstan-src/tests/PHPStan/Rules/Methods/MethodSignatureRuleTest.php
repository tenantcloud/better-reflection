 ...
 */
class MethodSignatureRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    /** @var bool */
    ...
    public function testRuleWithStaticMethods() : void
    {
        $this->reportMaybes = \true;
        $this->reportStatic = \true;
        $this->analyse([__DIR__ . '/data/method-signature-static.php'], [['Parameter #1 $value (string) of method MethodSignature\\Bar::doFoo() should be compatible with parameter $value (int) of method MethodSignature\\Foo::doFoo()', 24]]);
    }
    ...
    public function testBug3997() : void
    {
        $this->reportMaybes = \true;
        $this->reportStatic = \true;
        $this->analyse([__DIR__ . '/data/bug-3997.php'], [['Return type (string) of method Bug3997\\Ipsum::count() should be compatible with return type (int) of method Countable::count()', 59]]);
    }
    public function testBug4003() : void
    {
        ...
        $this->reportMaybes = \true;
        $this->reportStatic = \true;
        $this->analyse([__DIR__ . '/data/bug-4003.php'], [['Return type (string) of method Bug4003\\Baz::foo() should be compatible with return type (int) of method Bug4003\\Boo::foo()', 15], [\PHP_VERSION_ID < 70200 ? 'Parameter #1 $test (mixed) of method Bug4003\\Ipsum::doFoo() does not match parameter #1 $test (int) of method Bug4003\\Lorem::doFoo().' : 'Parameter #1 $test (string) of method Bug4003\\Ipsum::doFoo() should be compatible with parameter $test (int) of method Bug4003\\Lorem::doFoo()', 38]]);
    }
    ...
    public function testBug4017Two() : void
    {
        $this->reportMaybes = \true;
        $this->reportStatic = \true;
        $this->analyse([__DIR__ . '/data/bug-4017_2.php'], [['Parameter #1 $a (Bug4017_2\\Foo) of method Bug4017_2\\Lorem::doFoo() should be compatible with parameter $a (stdClass) of method Bug4017_2\\Bar<stdClass>::doFoo()', 51]]);
    }
    public function testBug4017Three() : void
    {
        $this->reportMaybes = \true;
        $this->reportStatic = \true;
        $this->analyse([__DIR__ . '/data/bug-4017_3.php'], [['Parameter #1 $a (T of stdClass) of method Bug4017_3\\Lorem::doFoo() should be compatible with parameter $a (Bug4017_3\\Foo) of method Bug4017_3\\Bar::doFoo()', 45]]);
    }
