...
class ReturnTypeRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    ...
    public function testBug2723() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/bug-2723.php'], [['Function Bug2723\\baz() should return Bug2723\\Bar<Bug2723\\Foo<T4>> but returns Bug2723\\BarOfFoo<string>.', 55]]);
    }
}
