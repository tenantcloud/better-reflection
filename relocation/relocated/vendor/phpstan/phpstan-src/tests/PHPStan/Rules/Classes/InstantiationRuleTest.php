 ...
 */
class InstantiationRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    protected function getRule() : \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Rule
    {
        $broker = $this->createReflectionProvider();
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Classes\InstantiationRule($broker, new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\FunctionCallParametersCheck(new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\RuleLevelHelper($broker, \true, \false, \true, \false), new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\NullsafeCheck(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Php\PhpVersion(80000), \true, \true, \true, \true), new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\ClassCaseSensitivityCheck($broker));
    }
    ...
    {
        $this->analyse([__DIR__ . '/data/bug-3404.php'], [['Class finfo constructor invoked with 3 parameters, 0-2 required.', 7]]);
    }
    public function testOldStyleConstructorOnPhp8() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/php80-constructor.php'], [['Class OldStyleConstructorOnPhp8 does not have a constructor and must be instantiated without any parameters.', 13], ['Class OldStyleConstructorOnPhp8 does not have a constructor and must be instantiated without any parameters.', 20]]);
    }
    public function testOldStyleConstructorOnPhp7() : void
    {
        ...
        $errors = [['Class OldStyleConstructorOnPhp8 constructor invoked with 0 parameters, 1 required.', 19]];
        if (!self::$useStaticReflectionProvider) {
            $errors[] = ['Methods with the same name as their class will not be constructors in a future version of PHP; OldStyleConstructorOnPhp8 has a deprecated constructor', 3];
        }
    ...
    public function testPromotedProperties() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/instantiation-promoted-properties.php'], [['Parameter #2 $bar of class InstantiationPromotedProperties\\Foo constructor expects array<string>, array<int, int> given.', 30], ['Parameter #2 $bar of class InstantiationPromotedProperties\\Bar constructor expects array<string>, array<int, int> given.', 33]]);
    }
    ...
    public function testNamedArguments() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/instantiation-named-arguments.php'], [['Missing parameter $j (int) in call to InstantiationNamedArguments\\Foo constructor.', 15], ['Unknown parameter $z in call to InstantiationNamedArguments\\Foo constructor.', 16]]);
    }
    public function testBug4471() : void
    {
        $this->analyse([__DIR__ . '/data/bug-4471.php'], [['Instantiated class Bug4471\\Baz not found.', 19, 'Learn more at https://phpstan.org/user-guide/discovering-symbols'], ['Instantiated class Bug4471\\Foo is abstract.', 24], ['Cannot instantiate interface Bug4471\\Bar.', 27]]);
    }
    ...
    {
        $this->analyse([__DIR__ . '/data/bug-3425.php'], [['Parameter #1 $iterator of class RecursiveIteratorIterator constructor expects T of IteratorAggregate|RecursiveIterator, Generator<int, int, mixed, void> given.', 5]]);
    }
}
