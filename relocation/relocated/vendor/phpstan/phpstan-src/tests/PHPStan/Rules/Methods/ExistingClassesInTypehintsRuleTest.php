 ...
 */
class ExistingClassesInTypehintsRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    /** @var int */
    ...
    public function testVoidParameterTypehint() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/void-parameter-typehint.php'], [['Parameter $param of method VoidParameterTypehintMethod\\Foo::doFoo() has invalid typehint type void.', 8]]);
    }
    public function dataNativeUnionTypes() : array
    {
        ...
        return [[70400, [['Method NativeUnionTypesSupport\\Foo::doFoo() uses native union types but they\'re supported only on PHP 8.0 and later.', 8], ['Method NativeUnionTypesSupport\\Foo::doBar() uses native union types but they\'re supported only on PHP 8.0 and later.', 13]]], [80000, []]];
    }
    /**
    ...
    {
        return [[70400, \PHP_VERSION_ID < 80000 || self::$useStaticReflectionProvider ? [] : [['Required parameter $bar follows optional parameter $foo', 8], ['Required parameter $bar follows optional parameter $foo', 17], ['Required parameter $bar follows optional parameter $foo', 21]]], [80000, [['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 8], ['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 17], ['Deprecated in PHP 8.0: Required parameter $bar follows optional parameter $foo.', 21]]]];
    }
    /**
    ...
    {
        $this->analyse([__DIR__ . '/data/bug-4641.php'], [['Template type U of method Bug4641\\I::getRepository() is not referenced in a parameter.', 26]]);
    }
}
