 ...
 */
class CallMethodsRuleTest extends \TenantCloud\BetterReflection\Relocated\PHPStan\Testing\RuleTestCase
{
    /** @var bool */
    ...
    protected function getRule() : \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Rule
    {
        ...
        $ruleLevelHelper = new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\RuleLevelHelper($broker, $this->checkNullables, $this->checkThisOnly, $this->checkUnionTypes, $this->checkExplicitMixed);
        return new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\Methods\CallMethodsRule($broker, new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\FunctionCallParametersCheck($ruleLevelHelper, new \TenantCloud\BetterReflection\Relocated\PHPStan\Rules\NullsafeCheck(), new \TenantCloud\BetterReflection\Relocated\PHPStan\Php\PhpVersion($this->phpVersion), \true, \true, \true, \true), $ruleLevelHelper, \true, \true);
    }
    ...
    public function testCallTraitMethods() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/call-trait-methods.php'], [['Call to an undefined method CallTraitMethods\\Baz::unexistentMethod().', 26]]);
    }
    ...
    public function testCallInterfaceMethods() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/call-interface-methods.php'], [['Call to an undefined method InterfaceMethods\\Baz::barMethod().', 25]]);
    }
    ...
    public function testCallToIncorrectCaseMethodName() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/incorrect-method-case.php'], [['Call to method IncorrectMethodCase\\Foo::fooBar() with incorrect case: foobar', 10]]);
    }
    public function testNullableParameters() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/nullable-parameters.php'], [['Method NullableParameters\\Foo::doFoo() invoked with 0 parameters, 2 required.', 6], ['Method NullableParameters\\Foo::doFoo() invoked with 1 parameter, 2 required.', 7], ['Method NullableParameters\\Foo::doFoo() invoked with 3 parameters, 2 required.', 10]]);
    }
    ...
    public function testCallMethodWithInheritDoc() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/calling-method-with-inheritdoc.php'], [['Parameter #1 $i of method MethodWithInheritDoc\\Baz::doFoo() expects int, string given.', 65], ['Parameter #1 $str of method MethodWithInheritDoc\\Foo::doBar() expects string, int given.', 67]]);
    }
    public function testCallMethodWithInheritDocWithoutCurlyBraces() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/calling-method-with-inheritdoc-without-curly-braces.php'], [['Parameter #1 $i of method MethodWithInheritDocWithoutCurlyBraces\\Baz::doFoo() expects int, string given.', 65], ['Parameter #1 $str of method MethodWithInheritDocWithoutCurlyBraces\\Foo::doBar() expects string, int given.', 67]]);
    }
    ...
    public function testInvokeMagicInvokeMethod() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/invoke-magic-method.php'], [['Parameter #1 $foo of method InvokeMagicInvokeMethod\\ClassForCallable::doFoo() expects callable(): mixed, InvokeMagicInvokeMethod\\ClassForCallable given.', 27]]);
    }
    public function testCheckNullables() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/check-nullables.php'], [['Parameter #1 $foo of method CheckNullables\\Foo::doFoo() expects string, null given.', 11], ['Parameter #1 $foo of method CheckNullables\\Foo::doFoo() expects string, string|null given.', 15]]);
    }
    public function testDoNotCheckNullables() : void
    {
        ...
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/check-nullables.php'], [['Parameter #1 $foo of method CheckNullables\\Foo::doFoo() expects string, null given.', 11]]);
    }
    public function testMysqliQuery() : void
    {
        ...
        $this->checkNullables = \false;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/mysqli-query.php'], [['Method mysqli::query() invoked with 0 parameters, 1-2 required.', 4]]);
    }
    ...
    public function testIterables(bool $checkNullables) : void
    {
        ...
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/call-methods-iterable.php'], [['Parameter #1 $ids of method CallMethodsIterables\\Uuid::bar() expects iterable<CallMethodsIterables\\Uuid>, array<int, null> given.', 14], ['Parameter #1 $iterable of method CallMethodsIterables\\Foo::acceptsSelfIterable() expects iterable<CallMethodsIterables\\Foo>, iterable<CallMethodsIterables\\Bar> given.', 59], ['Parameter #1 $iterable of method CallMethodsIterables\\Foo::acceptsSelfIterable() expects iterable<CallMethodsIterables\\Foo>, string given.', 60], ['Parameter #1 $iterableWithoutTypehint of method CallMethodsIterables\\Foo::doFoo() expects iterable, int given.', 62], ['Parameter #2 $iterableWithIterableTypehint of method CallMethodsIterables\\Foo::doFoo() expects iterable, int given.', 62], ['Parameter #3 $iterableWithConcreteTypehint of method CallMethodsIterables\\Foo::doFoo() expects iterable<CallMethodsIterables\\Bar>, int given.', 62], ['Parameter #4 $arrayWithIterableTypehint of method CallMethodsIterables\\Foo::doFoo() expects array, int given.', 62], ['Parameter #5 $unionIterableType of method CallMethodsIterables\\Foo::doFoo() expects CallMethodsIterables\\Collection&iterable<CallMethodsIterables\\Bar>, int given.', 62], ['Parameter #6 $mixedUnionIterableType of method CallMethodsIterables\\Foo::doFoo() expects array, int given.', 62], ['Parameter #7 $unionIterableIterableType of method CallMethodsIterables\\Foo::doFoo() expects CallMethodsIterables\\Collection&iterable<CallMethodsIterables\\Bar>, int given.', 62], ['Parameter #9 $integers of method CallMethodsIterables\\Foo::doFoo() expects iterable<int>, int given.', 62], ['Parameter #10 $mixeds of method CallMethodsIterables\\Foo::doFoo() expects iterable, int given.', 62]]);
    }
    public function testAcceptThrowable() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/accept-throwable.php'], [['Parameter #1 $i of method AcceptThrowable\\Foo::doBar() expects int, AcceptThrowable\\SomeInterface&Throwable given.', 41], ['Parameter #1 $i of method AcceptThrowable\\Foo::doBar() expects int, AcceptThrowable\\InterfaceExtendingThrowable given.', 44], ['Parameter #1 $i of method AcceptThrowable\\Foo::doBar() expects int, AcceptThrowable\\NonExceptionClass&Throwable given.', 47], ['Parameter #1 $i of method AcceptThrowable\\Foo::doBar() expects int, Exception given.', 50]]);
    }
    public function testWithoutCheckUnionTypes() : void
    {
        ...
        $this->analyse([__DIR__ . '/data/without-union-types.php'], [['Method CallMethodsWithoutUnionTypes\\Foo::doFoo() invoked with 3 parameters, 0 required.', 14]]);
    }
    public function testStrictTypes() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/call-methods-strict.php'], [['Parameter #1 $foo of method Test\\ClassWithToString::acceptsString() expects string, Test\\ClassWithToString given.', 7]]);
    }
    ...
    public function testClosureCallInvocations() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/closure-call.php'], [['Method Closure::call() invoked with 0 parameters, 2 required.', 9], ['Method Closure::call() invoked with 1 parameter, 2 required.', 10], ['Method Closure::call() invoked with 1 parameter, 2 required.', 11], ['Parameter #1 $newThis of method Closure::call() expects object, int given.', 11], ['Parameter #2 $thing of method Closure::call() expects object, int given.', 12], ['Parameter #1 $newThis of method Closure::call() expects object, int given.', 13], ['Method Closure::call() invoked with 3 parameters, 2 required.', 14], ['Result of method Closure::call() (void) is used.', 18]]);
    }
    ...
    public function testRecursiveIteratorIterator() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/recursive-iterator-iterator.php'], [['Method RecursiveDirectoryIterator::getSubPathname() invoked with 1 parameter, 0 required.', 14]]);
    }
    ...
    public function testExplicitMixed() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->checkExplicitMixed = \true;
        $this->analyse([__DIR__ . '/data/check-explicit-mixed.php'], [['Cannot call method foo() on mixed.', 17], ['Parameter #1 $i of method CheckExplicitMixedMethodCall\\Bar::doBar() expects int, mixed given.', 43], ['Parameter #1 $i of method CheckExplicitMixedMethodCall\\Bar::doBar() expects int, T given.', 65]]);
    }
    ...
    public function testBug2600() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/bug-2600.php'], [['Method Bug2600\\Foo::doBar() invoked with 3 parameters, 0-1 required.', 10]]);
    }
    ...
    public function testBug3445() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/bug-3445.php'], [['Parameter #1 $test of method Bug3445\\Foo::doFoo() expects Bug3445\\Foo, $this(Bug3445\\Bar) given.', 26]]);
    }
    public function testBug3481() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/bug-3481.php'], [['Method Bug3481\\Foo::doSomething() invoked with 2 parameters, 3 required.', 34], ['Parameter #1 $a of method Bug3481\\Foo::doSomething() expects string, int|string given.', 44]]);
    }
    public function testBug3683() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/bug-3683.php'], [['Parameter #1 $exception of method Generator<mixed,mixed,mixed,mixed>::throw() expects Throwable, int given.', 7]]);
    }
    ...
    public function testStringableStrictTypes() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/stringable-strict.php'], [['Parameter #1 $s of method TestStringables\\Dolor::doFoo() expects string, TestStringables\\Bar given.', 15]]);
    }
    public function testMatchExpressionVoidIsUsed() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/match-expr-void-used.php'], [['Result of method MatchExprVoidUsed\\Foo::doLorem() (void) is used.', 10], ['Result of method MatchExprVoidUsed\\Foo::doBar() (void) is used.', 11], ['Result of method MatchExprVoidUsed\\Foo::doBaz() (void) is used.', 11]]);
    }
    public function testNullSafe() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/nullsafe-method-call.php'], [['Method NullsafeMethodCall\\Foo::doBar() invoked with 1 parameter, 0 required.', 11], ['Parameter #1 $passedByRef of method NullsafeMethodCall\\Foo::doBaz() is passed by reference, so it expects variables only.', 26], ['Parameter #1 $passedByRef of method NullsafeMethodCall\\Foo::doBaz() is passed by reference, so it expects variables only.', 27]]);
    }
    public function testDisallowNamedArguments() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/disallow-named-arguments.php'], [['Named arguments are supported only on PHP 8.0 and later.', 10]]);
    }
    ...
    public function testBug4199() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/bug-4199.php'], [['Cannot call method answer() on Bug4199\\Baz|null.', 37]]);
    }
    ...
    public function testOnlyRelevantUnableToResolveTemplateType() : void
    {
        ...
        $this->checkNullables = \true;
        $this->checkUnionTypes = \true;
        $this->analyse([__DIR__ . '/data/only-relevant-unable-to-resolve-template-type.php'], [['Parameter #1 $a of method OnlyRelevantUnableToResolve\\Foo::doBaz() expects array, int given.', 41], ['Unable to resolve the template type T in call to method OnlyRelevantUnableToResolve\\Foo::doBaz()', 41, 'See: https://phpstan.org/blog/solving-phpstan-error-unable-to-resolve-template-type']]);
    }
