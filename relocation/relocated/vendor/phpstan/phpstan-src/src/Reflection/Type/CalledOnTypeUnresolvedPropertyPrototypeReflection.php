...
class CalledOnTypeUnresolvedPropertyPrototypeReflection implements \TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\Type\UnresolvedPropertyPrototypeReflection
{
    ...
    private \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type $fetchedOnType;
    public function __construct(\TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\PropertyReflection $propertyReflection, \TenantCloud\BetterReflection\Relocated\PHPStan\Reflection\ClassReflection $resolvedDeclaringClass, bool $resolveTemplateTypeMapToBounds, \TenantCloud\BetterReflection\Relocated\PHPStan\Type\Type $fetchedOnType)
    {
    ...
    {
        return new self($this->propertyReflection, $this->resolvedDeclaringClass, \false, $this->fetchedOnType);
    }
