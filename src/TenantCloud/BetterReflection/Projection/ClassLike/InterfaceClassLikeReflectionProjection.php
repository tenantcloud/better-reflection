...
use Ds\Sequence;
use TenantCloud\BetterReflection\Delegated\ClassLike\InterfaceClassLikeReflection;
use TenantCloud\BetterReflection\Projection\InterfaceReflectionProjection;
...
class InterfaceClassLikeReflectionProjection implements ClassLikeReflectionProjection
{
	private InterfaceClassLikeReflection $delegate;

	public function __construct(
		private InterfaceReflectionProjection $interfaceDelegate,
	) {
		$this->delegate = new InterfaceClassLikeReflection($interfaceDelegate);
	}
	...
	{
		return $this->interfaceDelegate->resolvedTypeParameterMap();
	}
